...
const FeatureSection = () => {
  const cardInfo = [
    ...
    {
      languge: "Node Js",
      icon: "https://cdn.iconscout.com/icon/free/png-512/free-nodejs-1-226034.png?f=webp&w=256",
      color: "shadow-green-500",
    },
    {
      languge: "Express Js",
      icon: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Status_iucn_EX_icon.svg/480px-Status_iucn_EX_icon.svg.png",
      color: "shadow-white",
    },
    {
      languge: "Next Js",
      icon: "https://miro.medium.com/v2/resize:fit:1000/1*KDMx1YspSrBcFJG-NDZgDg.png",
      color: "shadow-zinc-300",
    },
  ];
  return (
