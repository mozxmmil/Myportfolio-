    ...
    <div className="">
      <div className=" pt-20 pb-10 flex flex-col gap-5  items-center px-5  md:gap-4 lg:gap-20 justify-center w-full lg:flex lg:items-center lg:justify-center lg:px-10 lg:flex-row  md:flex-row">
        ...
        <motion.div
          ...
          className="w-[40vw]  border-2 min-h-[40vw] lg:w-[30vw] lg:min-h-[30vw]  rounded-full object-cover overflow-hidden "
        >
          <img
        ...
        <div className="  flex flex-col items-center py-5 px-2   min-h-[100px] md:ml-5 lg:ml-10 ">
          ...
          <motion.div className=" overflow-hidden ">
            <motion.h1 initial={{x:"300px"}} animate={{x:0}} transition={{ease:[0.76, 0, 0.24, 1],duration:1}}  in className=" text-3xl font-[Dancing Script] py-2">
              Mozammil
            </motion.h1>
          </motion.div>
          <div className=" text-center tracking-tight  ">
            <motion.h1 animate={{text:"pink"}} className="py-2 font-medium text-1xl lg:text-2xl md:text-2xl">
          ...
          <div className="flex gap-1 text-sm pt-3 pb-5 lg:gap-3 ">
            <div className="tracking-tight">
              <button
                ...
                className="border-2 px-4 py-2 lg:px-3 lg:py-3 md:px-3 md:py-3 rounded-full "
              >
                Download CV
              </button>
            </div>
